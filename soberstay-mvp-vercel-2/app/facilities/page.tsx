...
import { prisma } from "../../lib/prisma"; // <-- relative path from app/facilities
        ...
        <div className="features-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              {facilities.length} facilities found in Los Angeles, CA area
            </p>
          </div>
            ...
            <div className="filters-row">
              <div className="filter-group">
                ...
                <select className="filter-select">
                  ...
                  <option>$2,000 - $3,000/mo</option>
                  <option>$3,000 - $4,000/mo</option>
                  <option>Over $4,000/mo</option>
                </select>
              </div>
              <div className="filter-group">
              ...
              <Link key={f.id} href={`/facility/${f.slug}`} className="facility-card">
                <div className="facility-image">
                  <Image
                    ...
                    height={600}
                  />
                  <div className={`facility-badge ${f.verified ? "verified" : ""}`}>
